...
public class FavBandFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        List<Posts> lista = musicbeans.dataaccess.Posts.getPosts(Sesion.getInstance().getUsername());
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof PostFragment.OnFragmentInteractionListener) {
            mListener = (PostFragment.OnFragmentInteractionListener) context;
        } else {
